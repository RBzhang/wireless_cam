...
class b210test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "b210test")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10e3, math.pi, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_magphase_to_complex_0, 1))
...
def main(top_block_cls=b210test, options=None):
