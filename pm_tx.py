...
class pm_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._gain_range = qtgui.Range(0, 30, 1, 0, 200)
        ...
        self.pilot_sync_0 = pilot_sync_0.pilot_sync(sync_len=16, pilot_len=1024, diff_thresh=0.3, log_path="./diff.log")
        ...
        self.epy_block_0 = epy_block_0.image_byte_sink(width=80, height=40, output_path="/home/ray/Project/wireless-cam/received.png", save_sequence=False, display=True, skip_each_frame=1040)
