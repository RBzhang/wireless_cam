...
class pm_loop_usrp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_0 = epy_block_0.image_byte_sink(width=80, height=20, output_path="/home/ray/Project/wireless-cam/received.png", save_sequence=False, display=True, skip_each_frame=1084)
