...
import time
import math
import pm_loop_usrp_epy_block_0 as epy_block_0  # embedded python block
import pm_loop_usrp_image_byte_source_0 as image_byte_source_0  # embedded python block
...
class pm_loop_usrp(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pm_loop_usrp", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pm_loop_usrp")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "pm_loop_usrp")
        ...
        self.pilot_sync_0 = pilot_sync_0.pilot_sync(sync_len=64, pilot_len=1024, diff_thresh=0.3)
        ...
        self.image_byte_source_0 = image_byte_source_0.image_byte_source(image_path="/home/ray/Project/wireless-cam/colorbar80*40.png", repeat=True)
        self.epy_block_0 = epy_block_0.image_byte_sink(width=80, height=40, output_path="/home/ray/Project/wireless-cam/received.png", save_sequence=False, display=True, skip_each_frame=1088)
...
def main(top_block_cls=pm_loop_usrp, options=None):
